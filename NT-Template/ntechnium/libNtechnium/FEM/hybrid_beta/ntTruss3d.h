...
private:
	...
	arma::mat K_host;									//GLOBAL STIFFNESS
	arma::mat Kb_host;									//BOUNDARY CONDITIONS
	arma::mat Q_host;									//NODAL DISPLACEMENT
	arma::mat F_host;									//FORCE COMPONENTS
	arma::mat P_host;									//AXIAL FORCES
	arma::mat S_host;									//ELEMENT STRESSES
